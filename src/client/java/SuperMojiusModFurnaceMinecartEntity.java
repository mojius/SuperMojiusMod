...
public class FurnaceMinecartEntity extends AbstractMinecartEntity {
    ...
    public FurnaceMinecartEntity(EntityType<? extends net.minecraft.entity.vehicle.FurnaceMinecartEntity> entityType, World world) {
    ...
    static {
        LIT = DataTracker.registerData(net.minecraft.entity.vehicle.FurnaceMinecartEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        ACCEPTABLE_FUEL = Ingredient.ofItems(new ItemConvertible[]{Items.COAL, Items.CHARCOAL});
    }
}
